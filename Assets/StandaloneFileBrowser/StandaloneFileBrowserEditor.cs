...
namespace SFB
{
    public class StandaloneFileBrowserEditor : IStandaloneFileBrowser
    {
        ...
        {
            string path = "";
            if (extensions == null) path = EditorUtility.OpenFilePanel(title, directory, "");
            else path = EditorUtility.OpenFilePanelWithFilters(title, directory, GetFilterFromFileExtensionList(extensions));
