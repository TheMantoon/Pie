...
namespace SFB
{
    ...
    public class StandaloneFileBrowserLinux : IStandaloneFileBrowser {
        ...
        {
            _openFileCb = cb;
            DialogOpenFilePanelAsync(title, directory, GetFilterFromFileExtensionList(extensions), multiselect,
        ...
        {
            _openFolderCb = cb;
            DialogOpenFolderPanelAsync(title, directory, multiselect,
        ...
        {
            _saveFileCb = cb;
            DialogSaveFilePanelAsync(title, directory, defaultName, GetFilterFromFileExtensionList(extensions),
